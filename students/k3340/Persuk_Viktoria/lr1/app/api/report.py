'''
- [ ] GET /reports/summary — total income vs expenses (with date range filter)
- [ ] GET /reports/by-category — spending by category (with date range filter)

- Summary: SUM of amounts grouped by transaction type for a date range
- By-category: SUM of allocated_amounts grouped by category for a date range
'''
